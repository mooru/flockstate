 ...
 *   The form state.
 */
function flockstate_form_system_theme_settings_alter(&$form, &$form_state) {
    ...
    $form['mtt_settings']['tabs']['basic_settings']['breadcrumb_display'] = array(
        ...
        '#default_value' => theme_get_setting('breadcrumb_display','flockstate'),
    );
    ...
    $form['mtt_settings']['tabs']['basic_settings']['scrolltop_display'] = array(
        ...
        '#default_value' => theme_get_setting('scrolltop_display', 'flockstate'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );
    ...
    $form['mtt_settings']['tabs']['basic_settings']['bootstrap_js_include'] = array(
        ...
        '#default_value' => theme_get_setting('bootstrap_js_include', 'flockstate'),
        '#collapsible' => TRUE,
        '#collapsed' => TRUE,
    );
    ...
    $form['mtt_settings']['tabs']['ie8_support']['responsive_respond'] = array(
        ...
        '#default_value' => theme_get_setting('responsive_respond','flockstate'),
