...
<div id="page" class="clearfix">
    ...
    <div id="main-content">
        <div class="container">
            ...
            <!-- #messages-console -->
            <?php if ($messages):?>
            <div id="messages-console" class="clearfix" style="background-color:#eee;width:500px;margin:auto;height:185px;border:1px solid #ccc;box-shadow: 0px 1px 1px #BEBABA;">
                <div class="row">
                    <div class="col-md-12">
                    <p style="text-align:center;">Sorry, This Webpage Is Not Available. </p>
                    <p style="text-align:center;"><a class="btn btn-default" href='#' onclick='location.reload(true); return false;'>Try Again Soon</a></p>
                    </div>
                </div>
            </div>
            <?php endif; ?>
